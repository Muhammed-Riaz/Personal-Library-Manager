...
# Home Page
if menu == "🏠 Home":
    st.header("Welcome Personal Library Manager! 📖")
    st.write("Manage your book collection and also search ,  read status.")
    st.image("https://png.pngtree.com/background/20230427/original/pngtree-all-the-old-books-on-the-shelves-in-a-library-picture-image_2496728.jpg", use_container_width=True)
